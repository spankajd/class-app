...
export const ShareIcon = ({className, stroke = '#000'}) => {
  return (
    <svg viewBox="0 0 122.88 120.94" className={className}>
       <path fill={stroke} d="M98.11,0A24.77,24.77,0,1,1,80.6,42.28c-.22-.22-.43-.44-.64-.67l-31.14,13a25,25,0,0,1,.53,8.95L81,78.31A24.66,24.66,0,1,1,74.72,88L45.34,74.26A24.77,24.77,0,1,1,42.28,43c.44.44.87.9,1.27,1.37L74.29,31.55A24.77,24.77,0,0,1,98.11,0Z"/>
      </svg>
  );
}
...
export const HelpIcon = ({className, stroke = '#000', fill = '#000'}) => {
  return (
    <svg viewBox="0 0 512 512" className={className}>
       <path stroke={stroke} fill={fill} d="M317,458c0,29.8-24.2,54-54,54c-29.8,0-54-24.2-54-54c0-29.8,24.2-54,54-54C292.8,404,317,428.2,317,458z    M361.7,46.5C345,25.1,314.2,0,263,0c-135,0-140.6,123.8-140.6,125.7l32.6,0.9c0-3.7,3.7-93.1,107.1-93.1   c37.2,0,60.5,18.6,72.6,34.4c18.6,23.3,23.3,50.3,20.5,60.5c-9.3,41-33.5,62.4-58.6,84.7c-30.7,27.9-62.4,56.8-62.4,117.3h32.6   c0-46.5,23.3-67,52.1-93.1c27-24.2,56.8-51.2,68.9-101.5C393.4,114.5,385.9,77.3,361.7,46.5z"/>
      </svg>
  );
}
