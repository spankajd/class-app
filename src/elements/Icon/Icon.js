...
export const DoubleArrow = ({ className, stroke = '#000' }) => {
  return (
    <svg viewBox="0 0 23.949 15.776" className={className}>
      <g transform="translate(40.374 24.551) rotate(180)">
          <g transform="translate(18.54 13.891)">
            <line stroke={stroke} strokeWidth="3" strokeLinecap="round" x1="9.859" y2="8.544" transform="translate(19.717 8.544) rotate(180)"/>
            <line stroke={stroke} strokeWidth="3" strokeLinecap="round" x2="9.859" y2="8.544" transform="translate(9.859 8.544) rotate(180)"/>
          </g>
        <g transform="translate(23.784 10.891)">
          <line stroke={stroke} strokeWidth="3" strokeLinecap="round" x1="4.615" y2="4" transform="translate(9.231 4) rotate(180)"/>
          <line stroke={stroke} strokeWidth="3" strokeLinecap="round" x2="4.615" y2="4" transform="translate(4.615 4) rotate(180)"/>
        </g>
      </g>
    </svg>
  );
...
export const WebCamIcon = ({className, stroke = '#000', fill="none"}) => {
  return (
    <svg viewBox="0 0 80 80" className={className}>
      <path fill={fill} stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeMiterlimit="10" d="M60.618,65.729v-3.597
        c0,0-11.806-8.125-13.168-8.125c-2.763,2.056-11.45,2.181-14.781-0.03c-1.419,0-14.287,8.155-14.287,8.155v3.597H60.618z"/>
      <circle fill={fill} stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeMiterlimit="10" cx="40" cy="34.679" r="16.407"/>
      <circle fill="none" stroke={stroke} strokeLinecap="round" strokeMiterlimit="10" cx="40" cy="34.679" r="8.073"/>
      <circle fill="none" stroke={stroke} strokeLinecap="round" strokeMiterlimit="10" cx="40" cy="34.679" r="4.8"/>
      <circle fill="none" stroke={stroke} strokeLinecap="round" strokeMiterlimit="10" cx="48.449" cy="26.273" r="1.513"/>
      <path fill="none" stroke={stroke} strokeLinecap="round" strokeMiterlimit="10" d="M39.975,32.364
        c1.279,0,2.315,1.048,2.315,2.34"/>
      <path fill="none" stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeMiterlimit="10" d="M33.669,52.977"/>
    </svg>
  );
}

export const CursorIcon = ({className, stroke = '#000'}) => {
  return (
    <svg viewBox="0 0 20.621 29.406" className={className}>
      <path id="Shape_6026_copy_2" fill="none" stroke={stroke} strokeMiterlimit="10" d="M0.85,0.758C0,1.322,4.37,23.453,4.37,23.453
	      l4.37-4.512l6.63,9.727l4.369-2.818L13.25,15.7l6.631-1.551C19.88,14.149,1.69,0.194,0.85,0.758z"/>
    </svg>
  );
}

export const ScreenShotIcon = ({className, stroke = '#000'}) => {
  return (
    <svg viewBox="0 0 40.16 31.189" className={className}>
      <path id="Rounded_Rectangle_6019" fill="none" stroke={stroke} strokeMiterlimit="10" d="M5.533,1.273h29.352
        c2.688,0,4.865,2.147,4.865,4.796v20.325c0,2.648-2.18,4.796-4.865,4.796H5.533c-2.687,0-4.866-2.146-4.866-4.796V6.07
        C0.667,3.42,2.846,1.273,5.533,1.273z"/>
      <circle fill="none" stroke={stroke} strokeMiterlimit="10" cx="20.065" cy="16.852" r="5.655"/>
      <path id="Shape_1_copy_6" fill={stroke} d="M12.19,5.312H4.07v7.596h1.6V6.983h6.45L12.19,5.312z M27.46,5.5h8.12v7.592h-1.609
